...
<!--    <span class="action">-->
<!--&lt;!&ndash;      <a class="logout_title" target="_blank" href="http://doc.jeecg.com">&ndash;&gt;-->
<!--    <a class="logout_title" target="_blank" >-->
<!--        <a-icon type="question-circle-o"></a-icon>-->
<!--      </a>-->
<!--    </span>-->
<!--    <a class="action"  >-->
<!--      <a-icon type="bell"></a-icon>-->
<!--      <a-button @click="SendMsg()" type="dashed" block>发送信息</a-button>&ndash;&gt;-->
<!--    </a>-->

    <header-notice class="action" @changeflag="showflag" v-show="flag" />
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if (this.$route.query.redirectTool)
        window.location.href = this.$route.query.redirectTool + '?MindFallTicket=' + this.$store.getters.token
    },
    mounted() {
      //如果是单点登录模式
    ...
    methods: {
      ...
      SendMsg(){
        ...
        //this.$axios.post("sys/socketTest/sendUser")
