  ...
  <div class="main user-layout-register">
    ...
    <a-form-model ref="form" :model="model" :rules="validatorRules">
      <a-form-model-item prop="username">
        <a-input v-model="model.username" size="large" type="text" autocomplete="false" placeholder="请输入用户账号"/>
      </a-form-model-item>
      ...
      <a-form-model-item prop="realname">
        <a-input v-model="model.realname" size="large" type="text" autocomplete="false" placeholder="请输入用户昵称"/>
      </a-form-model-item>
      <a-form-model-item prop="email">
        <a-input v-model="model.email" size="large" type="email" autocomplete="false" placeholder="邮箱地址"></a-input>
      </a-form-model-item>
...
<!--      <a-form-model-item has-feedback prop="classify">-->
<!--        <a-select v-model="model.value"-->
<!--          placeholder="请选择一个角色!">-->
...
<!--      </a-form-model-item>-->
      <a-form-model-item prop="rolecode">
        <a-radio-group v-model="model.rolecode">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleRealnameCheck(rule, value, callback) {
      },
      ...
      handleSubmit2() {
        this.$refs['form'].validate(async (success) => {
          if (success == true) {
            ...
            await this.$axios.post("sys/user/emailRegister",register).then(res=>{
              if (!res.data.success) {
                console.log(res)
