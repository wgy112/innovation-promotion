<template>
  <a-card  style="background-color: white"  >
    <div style="margin-bottom: 3px" slot="title">
      <div style="margin-left: 200px">创新方法推广平台--需求查看  </div>
    </div>
    <a-form-model
      ref="ruleForm"
      :model="form"
    ...
    >
      ...
      <a-form-model-item label="企业需求描述" prop="description">
        <div style="border-style:groove;border-color: #afafaf;border-width: thin" v-html="form.description"/>
<!--        <J-editor v-model="form.description" class="text"></J-editor>-->
      </a-form-model-item>

      <a-form-model-item label="企业需求分类" prop="classify"  style="pointer-events: none">
